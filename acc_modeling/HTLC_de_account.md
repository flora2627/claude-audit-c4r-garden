...
### 📌 HTLC@initiate / initiateOnBehalf / initiateWithSignature
...
1. 🧾 变量变动表 (Function Delta Table):
   ...
   | `orders` (Liability) | 贷 (Credit) | 负债 (Liability) | Created new order obligation to redeemer/initiator. |
